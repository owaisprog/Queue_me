...
export function HomeIntegrations({ sx, ...other }: BoxProps) {
  const renderDescription = () => (
    <SectionTitle
      ...
      title="Smart Integrations for Seamless Operations"
      txtGradient="framework"
      description={
        <>
          <Box component="span" sx={{ mb: 1, display: 'block' }}>
          Effortlessly connect with powerful tools and platforms. Queue Me integrates with Payment Gateways, Marketing Tools, Booking Systems, and more, ensuring your shop’s operations run smoothly and efficiently.
          </Box>
