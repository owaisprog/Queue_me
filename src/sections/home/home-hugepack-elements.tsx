        ...
        <Container sx={{ textAlign: { xs: 'center', md: 'left' } }}>
          <Grid container rowSpacing={{ xs: 3, md: 0 }} columnSpacing={{ xs: 0, md: 8 }}>
            <Grid size={{ xs: 12, md: 6, lg: 7 }}>
              <SectionCaption title="All-in-One Service Solution" />
              <SectionTitle title="Comprehensive Tools for Success" txtGradient="elements" sx={{ mt: 3 }} />
            </Grid>
            ...
            <Grid size={{ xs: 12, md: 6, lg: 5 }}>
              <m.div variants={varFade('inUp', { distance: 24 })}>
                ...
                >
                  ...
                  Discover an all-in-one suite of powerful tools
                  </Box>
                  <br />
                  designed to enhance your shop’s operations. From intuitive menus and dynamic booking features to seamless customer interactions, Queue Me offers everything you need to deliver excellence—all in one place.
